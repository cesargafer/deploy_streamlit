...
#
# Controles para ingresar los datos del nuevo filme en el sidebar
st.sidebar.subheader("Ingrese los datos del nuevo filme")
nombre_input = st.sidebar.text_input("Nombre del Filme")
director_input = st.sidebar.text_input("Director")
genero_select = st.sidebar.selectbox("Género", ["Acción", "Comedia", "Drama", "Ciencia Ficción", "Suspenso", "Animación", "Documental"])
compañia_input = st.sidebar.text_input("Compañía Productora")
